...
Agenda 
Low precision computing for large language model (LLM) inference, Jiong Gong, Intel  (`slides <20231025-UXL-Low-precision-Optimization-for-LLM_JiongGong.pdf>`__)
