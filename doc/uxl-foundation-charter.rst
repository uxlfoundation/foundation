...
.. note::
   ...
   This document preserves the foundation's published charter and project
   context. For current interfaces, supported platforms and requirements,
   consult the `project directory <../PROJECTS.md>`__ and
   `dynamic specification <https://uxlfoundation.org/specifications/oneapi/technical-overview/>`__. Project descriptions below
   may reflect the period in which this document was written.
...
The `dynamic oneAPI specification`_ describes shared concepts and links to each
project's documentation, the canonical source for current APIs and requirements.
...
.. _`dynamic oneAPI specification`: https://uxlfoundation.org/specifications/oneapi/technical-overview/
...
.. _`oneDNN Maintainers`: https://github.com/uxlfoundation/oneDNN/blob/main/MAINTAINERS.md
.. _`oneDNN Contributing`: https://github.com/uxlfoundation/oneDNN/blob/main/CONTRIBUTING.md
