...
.. note::
   ...
   Historical 2025 record. For current APIs, see the
   `dynamic specification <https://uxlfoundation.org/specifications/oneapi/technical-overview/>`__.
   This page does not announce current programs,
