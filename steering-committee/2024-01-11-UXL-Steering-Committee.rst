...
specification and open-source work. A general
...
for open-source discussions to take place every two weeks. The cadence
for specification discussions remained to be decided.
...
The meeting discussed plans for migration of the
